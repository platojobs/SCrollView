...
@interface LTSimpleManagerDemom () <LTSimpleScrollViewDelegate>
...
@implementation LTSimpleManagerDemom
...
-(UILabel *)setupHeaderView {
    UILabel *headerView = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, 56)];
    headerView.backgroundColor = [UIColor yellowColor];
    headerView.text = @"惊喜连连";
...
-(NSArray <UIViewController *> *)setupViewControllers {
    ...
    [self.titles enumerateObjectsUsingBlock:^(NSString * _Nonnull obj, NSUInteger idx, BOOL * _Nonnull stop) {
        ...
        if (idx==0) {
            ...
            TfViewController*vc=[TfViewController new];
            [testVCS addObject:vc];
        }else{
